// @ts-nocheck — migrated legacy component; API types are enforced server-side
'use client'

import { useState, useEffect } from 'react'
import Layout from '@/components/layout/Layout'
import { APP_LANGUAGES } from '@/lib/languages'
import type { CheckDraftResponse, BulkScanResponse } from '@/types/api'
...
export default function BulkScan() {
  ...
  const [expansion, setExpansion] = useState<{
    suggestions: Array<{ keyword: string; source: string; appearsIn?: number }>
    autocomplete: string[]
    competitorWords: unknown[]
  ...
  const [draftResults, setDraftResults] = useState<Record<string, CheckDraftResponse>>({})
