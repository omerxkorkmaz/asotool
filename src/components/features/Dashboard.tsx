// @ts-nocheck — UI migrated from Pages Router; server-side types enforced in src/types
'use client'

import { useState, useEffect } from 'react'
import Layout from '@/components/layout/Layout'
import type { RivalAppResponse } from '@/types/scraper'

export default function Dashboard() {
  const [appId, setAppId] = useState('')
  const [savedId, setSavedId] = useState('')
  const [appInfo, setAppInfo] = useState<RivalAppResponse | null>(null)
